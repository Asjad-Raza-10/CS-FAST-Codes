...
-- Disable constraints (Azure-compatible)
ALTER TABLE specialization NOCHECK CONSTRAINT ALL;
ALTER TABLE doctor NOCHECK CONSTRAINT ALL;
ALTER TABLE dependent NOCHECK CONSTRAINT ALL;
ALTER TABLE spec_locations NOCHECK CONSTRAINT ALL;
ALTER TABLE surgery NOCHECK CONSTRAINT ALL;
ALTER TABLE performed_by NOCHECK CONSTRAINT ALL;
...
ALTER TABLE specialization CHECK CONSTRAINT ALL;
ALTER TABLE doctor CHECK CONSTRAINT ALL;
ALTER TABLE dependent CHECK CONSTRAINT ALL;
ALTER TABLE spec_locations CHECK CONSTRAINT ALL;
ALTER TABLE surgery CHECK CONSTRAINT ALL;
ALTER TABLE performed_by CHECK CONSTRAINT ALL;